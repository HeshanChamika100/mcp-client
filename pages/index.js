...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#232526] to-[#414345] flex items-center justify-center font-sans relative overflow-hidden p-4">
      ...
      <div className="absolute -top-20 -left-20 w-[220px] h-[220px] rounded-full z-0 opacity-25" style={{background: "radial-gradient(circle, #36d1c4 0%, transparent 70%)"}} />
      <div className="absolute -bottom-24 -right-24 w-[260px] h-[260px] rounded-full z-0 opacity-20" style={{background: "radial-gradient(circle, #ff0080 0%, transparent 70%)"}} />
      ...
      <div className="bg-[#1e1e1ee0] rounded-3xl shadow-2xl px-6 py-8 md:px-8 md:py-10 max-w-5xl w-full text-white text-center relative z-10 transition-shadow">
        <h1 className="text-2xl md:text-3xl font-extrabold mb-2 tracking-wide drop-shadow-lg">MCP Playground</h1>
        <p className="text-base md:text-lg text-gray-300 mb-6 md:mb-8 font-medium">Chat with Resume &amp; Send Email</p>
        ...
        <div className="flex flex-col lg:flex-row gap-6 md:gap-8 justify-center items-start">
          ...
          <div className="w-full lg:flex-1 bg-[#282828fa] rounded-2xl shadow-lg p-5 md:p-6">
            <label htmlFor="chat" className="text-base font-semibold block mb-2">Ask a question</label>
            ...
            <div className="mb-3">
              <p className="text-sm text-gray-400 mb-2">Try these sample questions:</p>
          ...
          {/* Send Email Section */}
          <div className="w-full lg:flex-1 bg-[#282828fa] rounded-2xl shadow-lg p-5 md:p-6">
            <label htmlFor="email" className="text-base font-semibold block mb-2">Send Email</label>
            ...
            <button
              onClick={sendEmail}
              disabled={loading || !email.recipient || !email.subject || !email.body}
